...
# from xlviews.format import CellContainer, ContainerStyle
# from xlviews.powerpoint.style import set_border, set_border_cell, set_fill
...
#                  border_style=None, font_size=10, preclean=True):
#     """
#     マージ機能付きの表を作成する．
#     """
...
#     shape = Shape(shape, parent=parent)
