...
pp = xv.PorwerPoint()
prs = pp.presentations.open('sample.pptx')
slide = prs.slides.add()
shape = slide.shapes.add_picture('figure.png')
"""
import os
import re
import tempfile
...
class PowerPoint(object):
    def __init__(self):
        self.api = win32com.client.Dispatch('PowerPoint.Application')

    def __repr__(self):
        return '<PowerPoint App>'
...
class Shapes(Collection):
    ...
    def add_picture(self, path=None, left=0, top=0, width=None, height=None,
                    scale=1, **kwargs):
        if not isinstance(path, str):
            return self.add_picture_matplotlib(path, left, top, width, scale,
                                               **kwargs)
    ...
    def add_picture_matplotlib(self, fig=None, left=0, top=0, width=None,
                               scale=1, dpi=None):
        if fig is None:
            fig = plt.gcf()
    ...
    def add_range(self, range_, data_type=2, left=None, top=None, width=None,
                  height=None):
        """
    ...
    def add_chart(self, chart, left=None, top=None, width=None, height=None,
        ...
        if hasattr(chart, 'save'):
            return self.add_chart_altair(chart, left, top, width, height,
                                         scale)
        else:
            return self.add_chart_xlwings(chart, left, top, width, height)

    def add_chart_altair(self, chart, left=None, top=None, width=None,
    ...
    def add_chart_xlwings(self, chart, left=None, top=None, width=None,
                          height=None):
        """
        Parameters
        ----------
    ...
    def add_label(self, text, left, top, width=72, height=72, auto_size=True,
                  **kwargs):
    ...
    def add_table(self, df, left=None, top=None, width=None, height=None,
                  merge=True, **kwargs):
        shape = create_table(self, df, left=100, top=100, width=300,
